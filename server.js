...
app.get("/", (req, res) => {
  res.send("<p>You are at localhost 4000</p>");
});

app.get("/breweries", (req, res) => {
  let queryData = req.query.brewery_type;
  console.log("brewery_type", req.query.brewery_type);
  if (queryData) {
...
app.get("/breweries/:id", (req, res) => {
  ...
  let filteredData = breweriesDB.find(
    (brewery) => brewery.id === parseInt(databaseID)
  );
  if (filteredData) {
    res.json(filteredData);
  } else {
    res.send("<p>no such data</p>");
  }
});
